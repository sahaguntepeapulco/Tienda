...
app.config['MYSQL_DATABASE_PASSWORD'] = 'jGxGZjj8kmle7w7F5UWk'  # Reemplaza ******** con tu contraseña real
app.config['MYSQL_DATABASE_DB'] = 'bkpxwmspyhvlwbsedoix'
app.config['MYSQL_DATABASE_PORT'] = 3306  # Agrega este campo para especificar el puerto
